...
class TestController extends Controller
{
    ...
    public function index(Request $request) {
        if($request->test) {
            $tests = Test::with('purpose')->select('id', 'name')->orderBy('id', 'desc')->get();
            ...
            $tests = Test::with(['purpose','test_questions'])->orderBy('id', 'desc')->paginate(10);
    ...
    public function show(Test $test) {
        ...
        $test_questions = Testquestion::with(['question', 'category'])->where('test_id', $test->id)->orderBy('id', 'asc')->get();
    ...
    public function update(Request $request, Test $test) {
        ...
        Testsetting::where('test_id', $test->id)->delete();
        ...
        Sectionsetting::where('test_id', $test->id)->delete();
        ...
        Ordersetting::where('test_id', $test->id)->delete();
    ...
    public function duplicate(Request $request) {
        ...
        if($request->id && $request->name) {
            ...
            if(!empty($test)) {
               ...
               $test_questions = Testquestion::where('test_id', $request->id)->get();
               $copy_questions = [];
               $i = 0;
               ...
               $test_settings = Testsetting::where('test_id', $request->id)->get();
               $copy_test_settings = [];
               $i = 0;
               foreach($test_settings as $test) {
                ...
                $section_settings = Sectionsetting::where('test_id', $request->id)->get();
                ...
                $order_settings = Ordersetting::where('test_id', $request->id)->get();
                $copy_order_settings = [];
                $i = 0;
    ...
    public function questions($test_id) {
        $test = Test::where('id', $test_id)->select('id', 'name')->first();
        $test_questions = Testquestion::where('test_id', $test_id)->with(['question', 'category'])->paginate(10);
