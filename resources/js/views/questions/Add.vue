                                ...
                                <form @submit.prevent="create">
                                    <div class="row mb-3">
                                        <div class="col-md-4 col-6">
                                            <div class="form-group">
                                                <label for="ques-category" class="mb-3 fw-bolder fs-5">Question
                                                    Category<span class="text-danger">*</span></label>
                                                <select
                                                    class="form-control form-control-solid form-control-sm status-filter"
                                                    v-model="question.category_id" placeholder="Question Category" required>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-12 col-12">
                                            <div class="form-group">
                                                <label for="ques-name" class="mb-3 fw-bolder fs-5">Question<span
                                                        class="text-danger">*</span></label>
                                                <tinymce id="tinymce1" v-model="question.title" placeholder="Enter Question"
                                                    required></tinymce>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mt-13 mb-3">
                                        ...
                                        <div class="col-md-3 col-12">
                                            <input type="text" class="form-control form-control-solid form-control-sm"
                                                v-model="question.options[1]" placeholder="Choice One" required>
                                            <div class="form-group checkbox-list mt-3">
                                                ...
                                                <input type="number" class="form-control form-control-sm"
                                                    v-model="question.marks" min="1" placeholder="Marks for the Question"
                                                    v-if="question.correct == 1" required>
                                            </div>
                                        </div>
                                        <div class="col-md-3 col-12">
                                            <input type="text" class="form-control form-control-solid form-control-sm"
                                                v-model="question.options[2]" placeholder="Choice Two" required>
                                            <div class="form-group checkbox-list mt-3">
                                                <div class="radio-inline">
                                                    <label class="radio mb-3">
                                                ...
                                                <input type="number" class="form-control form-control-sm"
                                                    v-model="question.marks" min="1" placeholder="Marks for the Question"
                                                    v-if="question.correct == 2" required>
                                            </div>
                                        </div>
                                        <div class="col-md-3 col-12">
                                            <input type="text" class="form-control form-control-solid form-control-sm"
                                                v-model="question.options[3]" placeholder="Choice Three" required>
                                            <div class="form-group checkbox-list mt-3">
                                                <div class="radio-inline">
                                                    <label class="radio mb-3">
                                                ...
                                                <input type="number" class="form-control form-control-sm"
                                                    v-model="question.marks" min="1" placeholder="Marks for the Question"
                                                    v-if="question.correct == 3" required>
                                            </div>
                                        </div>
                                        <div class="col-md-3 col-12">
                                            <input type="text" class="form-control form-control-solid form-control-sm"
                                                v-model="question.options[4]" placeholder="Choice Four" required>
                                            <div class="form-group checkbox-list mt-3">
                                                <div class="radio-inline">
                                                    <label class="radio mb-3">
                                                ...
                                                <input type="number" class="form-control form-control-sm"
                                                    v-model="question.marks" min="1" placeholder="Marks for the Question"
                                                    v-if="question.correct == 4" required>
                                            </div>
                                        </div>
                                        <div class="col-md-12 col-12 my-8">
                                            <textarea class="form-control form-control-solid form-control-sm"
                                                v-model="question.answers_justification"
                                                placeholder="Answer Justification"></textarea>
                                        </div>
                                            ...
                                            <ul class="list-unstyled list-inline m-0">
                                                <li class="list-inline-item">
                                                    <button type="submit" class="btn btn-dark btn-sm"
                                                        :disabled="disabled"><span class="spinner-grow spinner-grow-sm"
                                                            role="status" aria-hidden="true" v-if="disabled"></span>
                                                        Submit</button>
                                                </li>
                                                <li class="list-inline-item">
                                                    <router-link :to='{ name: "Question" }'
