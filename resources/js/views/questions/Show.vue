        ...
        <div class="toolbar" id="kt_toolbar">
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                <div data-kt-place="true" data-kt-place-mode="prepend"
                    ...
                    <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">Question #{{ this.$route.params.id
                    }}</h1>
                            ...
                            <div class="card-body">
                                <div class="row mb-3">
                                    <div class="col-md-4 col-6">
                                        <div class="form-group">
                                            <label for="ques-category" class="mb-2 fw-bolder fs-5">Question Category<span
                                                    class="text-danger">*</span></label>
                                            <select class="form-control form-control-solid form-control-sm status-filter"
                                                v-model="question.category_id" placeholder="Question Category" disabled
                                                required>
                                    ...
                                    <div class="col-md-8 col-6">
                                        <div class="d-flex align-items-center justify-content-md-end mb-4">
                                            <router-link :to='{ name: "Question" }' class="btn btn-sm btn-secondary">Back to
                                                List</router-link>
                                        </div>
                                    </div>
                                </div>
                                <div class="row  mb-3">
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
                                            <label for="ques-name" class="mb-2 fw-bolder fs-5">Question<span
                                                    class="text-danger">*</span></label>
                                ...
                                <div class="row mt-13  mb-3">
                                    ...
                                    <div class="col-md-3 col-12">
                                        <input type="text" class="form-control form-control-solid form-control-sm"
                                            v-model="question.options[1]" placeholder="Choice One" disabled>
                                        <div class="form-group checkbox-list mt-3">
                                            ...
                                            <input type="number" class="form-control" v-model="question.marks" min="1"
                                                placeholder="Marks for the Question" v-if="question.correct == 1"
                                                disabled />
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-12">
                                        <input type="text" class="form-control form-control-solid form-control-sm"
                                            v-model="question.options[2]" placeholder="Choice Two" disabled />
                                        <div class="form-group checkbox-list mt-3">
                                            <div class="radio-inline">
                                                <label class="radio mb-3">
                                            ...
                                            <input type="number" class="form-control" v-model="question.marks" min="1"
                                                placeholder="Marks for the Question" v-if="question.correct == 2"
                                                disabled />
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-12">
                                        <input type="text" class="form-control form-control-solid form-control-sm"
                                            v-model="question.options[3]" placeholder="Choice Three" disabled />
                                        <div class="form-group checkbox-list mt-3">
                                            <div class="radio-inline">
                                                <label class="radio mb-3">
                                            ...
                                            <input type="number" class="form-control" v-model="question.marks" min="1"
                                                placeholder="Marks for the Question" v-if="question.correct == 3"
                                                disabled />
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-12">
                                        <input type="text" class="form-control form-control-solid form-control-sm"
                                            v-model="question.options[4]" placeholder="Choice Four" disabled />
                                        <div class="form-group checkbox-list mt-3">
                                            <div class="radio-inline">
                                                <label class="radio mb-3">
                                            ...
                                            <input type="number" class="form-control" v-model="question.marks" min="1"
                                                placeholder="Marks for the Question" v-if="question.correct == 4"
                                                disabled />
                                        </div>
                                    </div>
                                    <div class="col-md-12 col-12 my-8">
                                        <textarea class="form-control form-control-solid form-control-sm"
                                            v-model="question.answers_justification" placeholder="Answer Justification"
                                            disabled></textarea>
                                    </div>
                                </div>
                            </div>
