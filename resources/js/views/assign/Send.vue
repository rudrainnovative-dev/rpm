   ...
   <div class="toolbar" id="kt_toolbar">
      <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
         <div data-kt-place="true" data-kt-place-mode="prepend" data-kt-place-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title me-3 mb-5 mb-lg-0 lh-1">
            <h1 class="d-flex align-items-center text-dark fw-bolder m-0 fs-3">Share with Candidates</h1>
            <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 mt-1">
               ...
               <li class="breadcrumb-item text-muted">
                  <p class="text-muted m-0 small">Share with Candidates</p>
               </li>
            </ul>
         </div>
      </div>
         ...
         <div class="row">
            <form @submit.prevent="sendMail">
               <div class="col-md-12 col-12">
                  <div class="card-body">
                     <h5 class="fw-bolder fs-3 text-capitalize">Candidates Email:</h5>
                     <div class="alert w-100 m-0 p-0 alert-dismissible fade show" :class="'alert'.index" v-for="(candidate, index) in this.assign.lists">        
   ...
   export default {
      ...
      methods:{
         async getCandidates() {
            ...
            Assign.show(this.$route.params.id).then(response => {
               this.assign.lists = response.data.assign.candidates
