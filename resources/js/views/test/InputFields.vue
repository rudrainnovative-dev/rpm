            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                <div data-kt-place="true" data-kt-place-mode="prepend" data-kt-place-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title me-3 mb-5 mb-lg-0 lh-1">
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 mt-1">
                        ...
                        <li class="breadcrumb-item text-muted">
                            <p class="text-muted m-0 small">Registration Fields for Candidate</p>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-12 col-12">
                        <div class="d-flex align-items-center justify-content-md-end mb-4">
                            <router-link :to='{name:"Test"}' class="btn btn-sm btn-secondary me-4 router-link-active">Back to List</router-link>
                        </div>
                    </div>
                                            ...
                                            <table class="table table-rounded table-striped border gy-7 gs-7 m-0 m-0">
                                                <thead>
                                                    <tr class="fw-bold fs-6 text-gray-800 border-bottom border-gray-200">
                                                        ...
                                                        <th class="fw-bolder align-middle">Required</th>
                                                        <th class="fw-bolder align-middle">Allow</th>
                                                    </tr>
                                                </thead>
