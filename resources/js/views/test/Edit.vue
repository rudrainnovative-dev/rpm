                                ...
                                <div class="separator"></div>
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-4 col-12">
                                                <div class="form-group">
                                                    <label class="mb-2 fw-bold">Search & Add Skill to the Test<span class="text-danger">*</span></label>
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h2 v-if="selected_skills == 1">Select Question From Other Test</h2>
                                <h2 v-if="selected_skills == 2">Select Question From Question Bank</h2>
                            ...
                            <div class="stepper stepper-pills stepper-column d-flex flex-column flex-xl-row flex-row-fluid" id="kt_modal_create_app_stepper" data-kt-stepper="true">
                                <div class="row">
                                    <div class="col-sm-12" v-if="selected_skills == 1">
                                    ...
                                    <div class="col-sm-12" v-if="selected_skills == 2">
                                    ...
                                    <div class="col-sm-12" id="min_height_model_div">
                                        <table class="table table-rounded table-striped border gy-7 gs-7 m-0">
                                            <thead>
                                                <tr>
                                                    <th>#</th>
                                    ...
                                    <div class="col-sm-12">
                                        <span class="d-block text-info mb-4" v-if="test.selected_question.length > 0">{{ test.selected_question.length }} Question(s) Selected.</span>
