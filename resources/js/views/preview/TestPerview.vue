...
<script>
    ...
    export default {
        name:"online-test",
        components: { LogoHeader, Remember, Reportdisplay },
        mounted() {
            this.getTest()
        },
        data() {
            ...
            async getTest() {
                ...
                Online.index(this.$route.params.id, 'YWRtaW4=').then(response => {
                    ...
                    if(this.categories.length == 0) {
                        this.test.errors.validate = "This test has not been created completed. Please contact your administrator for assistance."
